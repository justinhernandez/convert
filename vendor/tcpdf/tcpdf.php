...
if (!class_exists('TCPDF', false)) {
	 ...
	 */ 
	define('PDF_PRODUCER','TCPDF 4.3.009 (http://www.tcpdf.org)');
	 ...
	 /**
		...
		*/
		protected function _puttruetypeunicode($font) {
			...
			$this->_newobj();
			$this->_out('<</Registry '.$this->_datastring('Adobe')); // A string identifying an issuer of character collections
			$this->_out('/Ordering '.$this->_datastring('Identity')); // was 'UCS'
